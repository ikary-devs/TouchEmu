...
namespace TouchEmu.Core.Common.Managers.Data
{
        ...
        public void FillData()
        {
            foreach (var registeredData in this._data)
            {
                ...
                try
                {
                    ...
                    Type entityType = Type.GetType($"TouchEmu.Core.Common.Entity.Data.{registeredData.Key}, TouchEmu.Core.Common", true);
