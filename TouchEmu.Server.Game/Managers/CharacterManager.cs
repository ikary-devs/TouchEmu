...
using TouchEmu.Core.Ankama.Protocol.Enums;
...
using TouchEmu.Server.Game.Frames;
...
namespace TouchEmu.Server.Game.Managers
{
    ...
    public class CharacterManager : AbstractGameManager, ICharacterManager
    {
        ...
        public async Task CharacterSelection(GameClient client, int selectedCharacterId)
        {
            ...
            client.Send(new TextInformationMessage(1, 89, new int[] {}, "Bienvenue sur <b>TouchEmu</b>, serveur en version BETA développé par Ten !" ));
